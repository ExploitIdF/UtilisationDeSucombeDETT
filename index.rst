...
##################################################
Dernière mise à jour : novembre 2024 (création mars 2024)
...
Dans la prémière version du document, on s'était limité aux données accessibles par l'interface (version 2020). Cependant, en novembre 2024, on a pu avoir accès à la base de donnée sousjacente de l'application par la récupération du fichier de sauegarde PostGreSql. Ces données permettent des exploitations plus avancées, en particulier sur les montants constatés.
